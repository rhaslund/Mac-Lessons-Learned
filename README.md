...
- Install applications automatically from AppStore using Homebrew utility: mas - example: mas install 6504861501 (to install Ghostery ad-blocker). Update using command: mas upgrade
